import { IsOptional, IsString, IsEnum, IsNumber, IsBoolean, IsArray, IsUrl } from 'class-validator';
...
export class UpdateArticleDto {
  ...
  @ApiProperty({ description: '文章内容', example: '这是文章内容...', required: false })
  @IsOptional()
  ...
  @ApiProperty({ description: '文章状态', enum: ['draft', 'pending', 'published'], example: 'published', required: false })
  @IsOptional()
