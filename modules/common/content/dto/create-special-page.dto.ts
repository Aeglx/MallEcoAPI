import { IsNotEmpty, IsString, IsOptional, IsEnum, IsBoolean, IsObject } from 'class-validator';
import { Type } from 'class-transformer';
import { ApiProperty } from '@nestjs/swagger';

export class CreateSpecialPageDto {
  @ApiProperty({ description: '专题页面标题', example: '双十一大促专题' })
  @IsNotEmpty({ message: '专题页面标题不能为空' })
  ...
  @ApiProperty({ description: '专题页面状态', enum: ['draft', 'published', 'archived'], example: 'draft' })
