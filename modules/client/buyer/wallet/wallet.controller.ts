...
export class WalletController {
  ...
  async getWalletInfo(@CurrentUser() user: any): Promise<ResponseModel<any>> {
  ...
  @ApiResponse({ status: 200, description: '获取成功' })
  async getRechargeDetail(@Param('orderNo') orderNo: string): Promise<ResponseModel<any>> {
  ...
  @ApiResponse({ status: 200, description: '获取成功' })
  async getPointsInfo(@CurrentUser() user: any): Promise<ResponseModel<any>> {
  ...
  @ApiQuery({ name: 'limit', description: '每页数量', required: false, example: 10 })
  @ApiResponse({ status: 200, description: '获取成功' })
  async getPointsGoods(@Query() query: any): Promise<ResponseModel<any>> {
  ...
  @ApiResponse({ status: 200, description: '获取成功' })
  async getPointsExchangeDetail(@Param('exchangeNo') exchangeNo: string): Promise<ResponseModel<any>> {
  ...
  @ApiResponse({ status: 200, description: '获取成功' })
  async getMyWalletStatistics(@CurrentUser() user: any): Promise<ResponseModel<any>> {
