...
export class UpdateSpecialPageSectionDto {
  @ApiProperty({ description: '区块标题', example: '热销商品推荐', required: false })
  @IsOptional()
  ...
  @ApiProperty({ description: '区块类型', enum: ['banner', 'product', 'article', 'video', 'custom'], example: 'banner', required: false })
  @IsOptional()
