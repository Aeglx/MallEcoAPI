...
export class EmailLog {
  ...
  @Column({ name: 'to_email', type: 'varchar', length: 100, nullable: false, comment: '收件人邮箱' })
  toEmail: string;
  ...
  @Column({ name: 'email_type', type: 'tinyint', nullable: false, comment: '邮件类型: 1-验证码 2-通知 3-营销' })
  emailType: number;
