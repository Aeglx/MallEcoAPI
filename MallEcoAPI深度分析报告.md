...
- 购物车管理: `/buyer/cart`
- 订单管理: `/buyer/order`
- 商品浏览: `/buyer/product` (支持搜索、筛选、排序)
- 会员管理: `/buyer/member`
- 搜索系统: `/buyer/search` (热门搜索、搜索历史、搜索联想)
- 钱包系统: `/buyer/wallet` (钱包信息、交易记录、转账)
- 内容搜索: `/buyer/content` (文章、专题搜索)
...
- 系统配置: `/manager/config`
- 基础数据管理
- 搜索管理: `/manager/search` (热门关键词管理)
- 钱包管理: `/manager/wallet` (钱包监控、冻结/解冻)
